...
public class DealsPage extends BasePage {
    ...
    com.automation.pageElements.GG_Deals_PromoPageElements GG_Deals_PromoPageElements = new GG_Deals_PromoPageElements();

    com.automation.pageElements.GG_Deals_BOGOPageElement GG_Deals_BOGOPageElement = new GG_Deals_BOGOPageElement();
