...
public class UCAServices extends RestService{

	public UCAServices(AppiumDriver driver) {
		super(driver);
	}
...
public Result getPreferredStore() {
	...
	String url = this.hostUrl + "/abs/acceptancepub/cnc/ucaservice/api/uca/customers/557-176-1602819374970/stores";
...
public Result getUCAProfile() {
	...
	String url = this.hostUrl + "/abs/acceptancepub/cnc/ucaservice/api/uca/customers/557-176-1602819374970/profile?full=y";
