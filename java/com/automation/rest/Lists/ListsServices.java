...
public class ListsServices extends RestService{

	public ListsServices(AppiumDriver driver) {
		super(driver);
	}
...
public Result getMyList() {
		...
		String url = this.nimbusUrl + "/emmd/service/mylist/default/details?storeId=4601";
		
		Map<String, String> headers = RestApiConfig.getUrlEncodeHeaders();
		
		headers.put("ADRUM_1", "isMobile:true");

		headers.put("X-SWY_MOBILE_VERSION", "1.0");
